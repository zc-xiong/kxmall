<template>
	<view class="coupon_box">
		...
		<coupon v-for="(item, index) in obatinableCouponList" v-if="item.surplus > 0" :key="index" v-bind:item="item" :index="index" @shareCoupon="shareCoupon" @useCoupon="useCoupon"
		 @obtainCoupon="obtainCoupon" theme="#ff0000"></coupon>
